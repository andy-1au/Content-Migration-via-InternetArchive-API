...
TAGS_WANTED = {'language', 'subject', 'volume', 'pub_date', 'call_number', 'publisher', 'description',
               'copyright_status', 'identifier', 'ppi', 'camera',
               'scandate'}  # SET used to search for specific tags in XML file, also have to CHANGE 'date' tag here

replaceList = {'language': 'Language-Code', 'subject': 'Subject-Topic', 'volume': 'Volume-Number',
               'pub_date': 'Date-Created', 'call_number': 'Call-Number', 'publisher': 'Publisher',
               'description': 'Description-Abstract',
               'copyright_status': 'Rights', 'mediatype': 'Type', 'identifier': 'Identifier', 'ppi': 'PPI',
               "camera": 'Capture-Device',
               'scandate': 'Date-Captured'}
...
itemList = 'S:/Digital Projects/Internet Archive Downloads/Engineering Society Journal/engineering_society_journal_itemlist.txt'  # itemlist directory (CHANGE)
...
xmlDP = 'S:/Digital Projects/Internet Archive Downloads/Engineering Society Journal/XML'  # String to capture a longer directory address cause API call has some restrictions (CHANGE)
...
for i in range(txtLength):
    ...
    csvPath = 'S:/Digital Projects/Internet Archive Downloads/Engineering Society Journal/CSV/'  # (CHANGE) directory path for where CSV file is located
    ...
    scanDataDP = 'S:/Digital Projects/Internet Archive Downloads/Engineering Society Journal/scandata'  # (CHANGE) DIRECTORY
    ...
    SDFolderPath = 'S:/Digital Projects/Internet Archive Downloads/Engineering Society Journal/' # (CHANGE)
    SDFolderFileName = lines[i] + '_jp2/'
    finalSDPath = SDFolderPath + SDFolderFileName  # single folder, no dup folders
    ...
    folderName_add = "Engineering Society Journal" # (CHANGE)
    ...
    for j in range(len(imagesList)):
        ...
        object_location_add = "Internet Archive Downloads/" + folderName_add + "/" + SDFolderFileName + imagesList[j]
